...
interface CandidateDetailProps {
  ...
  industryInput: string;
  selectedIndustryType: string;
  qualifications: string[];<previous_generation>```text

</previous_generation>  skills: string[];
}
...
export default function CandidateSearchUITestPage() {
  ...
  const [minSalary, setMinSalary] = useState(''); const [maxSalary, setMaxSalary] = useState('');
